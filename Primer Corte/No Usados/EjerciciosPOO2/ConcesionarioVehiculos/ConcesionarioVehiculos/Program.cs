...
namespace ConcesionarioVehiculos
{
    internal class Program
    {
        ...
        static void MostrarTodosLosVehiculos()
        {
            Console.WriteLine("\n--- Lista de Vehículos Registrados ---");
            
            foreach(var vehiculo in Vehiculo)
            {
                Console.WriteLine($"ID: {vehiculo.Id} | Marca: {vehiculo.Marca} | Modelo: {vehiculo.Modelo} | Año: {vehiculo.Año} | Precio Base: {vehiculo.PrecioBase:C}");
            }
        }
    }
}
